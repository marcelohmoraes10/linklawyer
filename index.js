...
const users = [ // criando um array de exemplo
    ...
    {id: 1, tipo: "Advogado", nome: "Ana"},
    {id: 1, tipo: "Cliente", nome: "Pedro"}
];
...
app.post("/users",(req,res) => {    // adicionando um usuário pela url
    ...
    const user = {  // definindo de onde virão os atributos dos usuários
        id: users.length +1,
        tipo: req.body.tipo,
        nome: req.body.nome
    };
